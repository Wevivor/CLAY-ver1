...
import 'package:clay/h_search/part_search/controllers/search_keyword_list_controller.dart';
import 'package:clay/h_search/part_search/models/search_keyword.dart';
import 'package:get/get.dart';

class SearchHan<T> extends SearchDelegate<String> {
  // List<FindWord> data = [];

  SearchHan(String label)
      : super(
