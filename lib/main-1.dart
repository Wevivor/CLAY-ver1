...
import 'h_push/ui_push_list.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    //   debugPrint("===================> MEMORY:3 URLS) $value");
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) {
      if (_sharedMemory != null || _sharedMemory != null) {
        // ReceiveSharingIntent.reset();
        debugPrint(
            '[SHARE MEMORY]:${_sharedMemory}, [SHARETEXT]: ${_sharedMemory} ');
    ...
    return GetMaterialApp(
      ...
      // initialRoute: (_sharedMemory != null || _sharedText != null)
      //     ? '/share_service'
      //     : '/login',
